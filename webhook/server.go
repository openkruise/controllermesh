...
import (
	...
	"github.com/openkruise/controllermesh/webhook/pod"
	webhookutil "github.com/openkruise/controllermesh/webhook/util"
	webhookcontroller "github.com/openkruise/controllermesh/webhook/util/controller"
	"github.com/openkruise/controllermesh/webhook/util/health"
	"github.com/openkruise/controllermesh/webhook/virtualapp"
	"k8s.io/klog/v2"
...
func init() {
	...
	addHandlers(virtualapp.HandlerMap)
}
