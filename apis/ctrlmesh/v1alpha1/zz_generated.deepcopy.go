...
func (in *VirtualAppConfiguration) DeepCopyInto(out *VirtualAppConfiguration) {
	*out = *in
	...
	if in.RestConfigOverrides != nil {
		in, out := &in.RestConfigOverrides, &out.RestConfigOverrides
...
func (in *VirtualAppRoute) DeepCopyInto(out *VirtualAppRoute) {
	*out = *in
	...
	if in.SubsetDefaultOnlyUserAgents != nil {
		in, out := &in.SubsetDefaultOnlyUserAgents, &out.SubsetDefaultOnlyUserAgents
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
